...
The analysis is deliberately conservative in what it counts: a vulnerability is
tallied as structurally containable only where the mechanism holds structurally,
and we report the payload-backed and projected figures separately so the coverage
of each claim is explicit.
