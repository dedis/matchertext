...
Matchertext offers a \emph{structural} guarantee: no untrusted value, in any
position, can escape its delimiters or alter the surrounding query structure,
which eliminates the entire class of injection that depends on breaking out of a
delimiter.
