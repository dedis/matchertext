...
Neither premise removes the parser from the trusted base.
A1 relocates a bounded part of the sink's parser, and A2 adds a lexical form to
the application language; together they replace an obligation on the programmer
at every use site with an obligation on two parsers
