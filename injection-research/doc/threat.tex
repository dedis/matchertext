...
argument adds to the host.
The boundary-locating step of (i) is the operationally load-bearing part; we
discharge it below as premise L1, machine-checked in Lean
(\cref{sec:appendix:lean}), so what the host must still be trusted for is the
