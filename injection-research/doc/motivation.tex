...
the motivation for the structural approach this paper evaluates.
...
Each is written for one composing language and one host, and works by knowing the
...
that reads to matcher balance, and such a host accepts values from every such
