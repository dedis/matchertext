...
unconstrained, and they become ordinary data inside a matched region, which
closure keeps balanced whatever nonmatchers the value carries.
...
compares with the defenses already deployed for these hosts.
