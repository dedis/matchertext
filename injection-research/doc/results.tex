...
\verb|<? <id>| (110).
The tail is long rather than mis-merged: the singletons are 85\% of groups but
only 36\% of CVEs, and they collapse to fifteen distinct verdicts, since the
skeleton preserves tags and operators that the containment test does not depend
on.
