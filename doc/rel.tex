...
Previous work like \emph{Dyck Language}~\cite{chomsky63algebraic} already
encompass a big part of the discipline matchertext puts forward, since matchertext
is itself a Dyck Language with extra neutral symbols.
